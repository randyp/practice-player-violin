...
const TWINKLE_VARIATIONS = {
  id: "twinkle-variations", group: "Introductory songs", title: "Twinkle Twinkle Little Star Variations", source: "Suzuki",
  ...
  melody: { measures: [
    ...
    [R("w")],
    [R("w")],
    // Var. A: eighth-eighth-rest-eighth per note
    ...
    [N(3, "8"), N(3, "8"), R("8"), N(3, "8"), N(2, "8"), N(2, "8"), R("8"), N(2, "8")],
    [N(1, "8"), N(1, "8"), R("8"), N(1, "8"), N(0, "8"), N(0, "8"), R("8"), N(0, "8")],
    // Var. B: eighth + two sixteenths, twice per note
