...
const LIGHTLY_ROW = {
  id: "lightly-row", group: "Introductory songs", title: "Lightly Row", source: "Suzuki",
  defaultTempo: 110, keys: ["D4", "G3", "A4"], defaultKey: "A4", repeats: [],
  timeSignature: "4/4",
  melody: { measures: [
    [N(4, "q"), N(2, "q"), N(2, "h")],
    [N(3, "q"), N(1, "q"), N(1, "h")],
    [N(0, "q"), N(1, "q"), N(2, "q"), N(3, "q")],
    [N(4, "q"), N(4, "q"), N(4, "h")],
    [N(4, "q"), N(2, "q"), N(2, "q"), N(2, "q")],
    [N(3, "q"), N(1, "q"), N(1, "q"), N(1, "q")],
    [N(0, "q"), N(2, "q"), N(4, "q"), N(4, "q")],
    [N(2, "q"), N(2, "q"), N(2, "h")],
    [N(1, "q"), N(1, "q"), N(1, "q"), N(1, "q")],
    [N(1, "q"), N(2, "q"), N(3, "h")],
    [N(2, "q"), N(2, "q"), N(2, "q"), N(2, "q")],
    [N(2, "q"), N(3, "q"), N(4, "h")],
    [N(4, "q"), N(2, "q"), N(2, "q"), N(2, "q")],
    [N(3, "q"), N(1, "q"), N(1, "q"), N(1, "q")],
    [N(0, "q"), N(2, "q"), N(4, "q"), N(4, "q")],
...
function twinkleSong(id, sub, melodyMeasures) {
  return {
    id, group: "Introductory songs", title: "Twinkle Twinkle Little Star", sub, source: "Suzuki",
    defaultTempo: 100, keys: ["A4", "G3", "D4"], defaultKey: "A4", repeats: [],
    timeSignature: "4/4",
    melody: { measures: melodyMeasures },
  };
}

const TWINKLE_8888QQ = twinkleSong("twinkle-8888qq", "8888QQ", [
  [N(0, "8"), N(0, "8"), N(0, "8"), N(0, "8"), N(0, "q"), N(0, "q")],
  [N(4, "8"), N(4, "8"), N(4, "8"), N(4, "8"), N(4, "q"), N(4, "q")],
  [N(5, "8"), N(5, "8"), N(5, "8"), N(5, "8"), N(5, "q"), N(5, "q")],
  [N(4, "8"), N(4, "8"), N(4, "8"), N(4, "8"), N(4, "q"), N(4, "q")],
  [N(3, "8"), N(3, "8"), N(3, "8"), N(3, "8"), N(3, "q"), N(3, "q")],
  [N(2, "8"), N(2, "8"), N(2, "8"), N(2, "8"), N(2, "q"), N(2, "q")],
  [N(1, "8"), N(1, "8"), N(1, "8"), N(1, "8"), N(1, "q"), N(1, "q")],
  [N(0, "8"), N(0, "8"), N(0, "8"), N(0, "8"), N(0, "q"), N(0, "q")],
  [N(4, "8"), N(4, "8"), N(4, "8"), N(4, "8"), N(4, "q"), N(4, "q")],
  [N(3, "8"), N(3, "8"), N(3, "8"), N(3, "8"), N(3, "q"), N(3, "q")],
  [N(2, "8"), N(2, "8"), N(2, "8"), N(2, "8"), N(2, "q"), N(2, "q")],
...
const TWINKLE_88R8 = twinkleSong("twinkle-88r8", "88R8", [
  [N(0, "8"), N(0, "8"), R("8"), N(0, "8"), N(4, "8"), N(4, "8"), R("8"), N(4, "8")],
  [N(5, "8"), N(5, "8"), R("8"), N(5, "8"), N(4, "8"), N(4, "8"), R("8"), N(4, "8")],
  [N(3, "8"), N(3, "8"), R("8"), N(3, "8"), N(2, "8"), N(2, "8"), R("8"), N(2, "8")],
  [N(1, "8"), N(1, "8"), R("8"), N(1, "8"), N(0, "8"), N(0, "8"), R("8"), N(0, "8")],
  [N(4, "8"), N(4, "8"), R("8"), N(4, "8"), N(3, "8"), N(3, "8"), R("8"), N(3, "8")],
  [N(2, "8"), N(2, "8"), R("8"), N(2, "8"), N(1, "8"), N(1, "8"), R("8"), N(1, "8")],
  [N(4, "8"), N(4, "8"), R("8"), N(4, "8"), N(3, "8"), N(3, "8"), R("8"), N(3, "8")],
  [N(2, "8"), N(2, "8"), R("8"), N(2, "8"), N(1, "8"), N(1, "8"), R("8"), N(1, "8")],
  [N(0, "8"), N(0, "8"), R("8"), N(0, "8"), N(4, "8"), N(4, "8"), R("8"), N(4, "8")],
  [N(5, "8"), N(5, "8"), R("8"), N(5, "8"), N(4, "8"), N(4, "8"), R("8"), N(4, "8")],
...
const TWINKLE_8SS = twinkleSong("twinkle-8ss", "8SS", [
  [N(0, "8"), N(0, "16"), N(0, "16"), N(0, "8"), N(0, "16"), N(0, "16"), N(4, "8"), N(4, "16"), N(4, "16"), N(4, "8"), N(4, "16"), N(4, "16")],
  [N(5, "8"), N(5, "16"), N(5, "16"), N(5, "8"), N(5, "16"), N(5, "16"), N(4, "8"), N(4, "16"), N(4, "16"), N(4, "8"), N(4, "16"), N(4, "16")],
  [N(3, "8"), N(3, "16"), N(3, "16"), N(3, "8"), N(3, "16"), N(3, "16"), N(2, "8"), N(2, "16"), N(2, "16"), N(2, "8"), N(2, "16"), N(2, "16")],
  [N(1, "8"), N(1, "16"), N(1, "16"), N(1, "8"), N(1, "16"), N(1, "16"), N(0, "8"), N(0, "16"), N(0, "16"), N(0, "8"), N(0, "16"), N(0, "16")],
  [N(4, "8"), N(4, "16"), N(4, "16"), N(4, "8"), N(4, "16"), N(4, "16"), N(3, "8"), N(3, "16"), N(3, "16"), N(3, "8"), N(3, "16"), N(3, "16")],
  [N(2, "8"), N(2, "16"), N(2, "16"), N(2, "8"), N(2, "16"), N(2, "16"), N(1, "8"), N(1, "16"), N(1, "16"), N(1, "8"), N(1, "16"), N(1, "16")],
  [N(4, "8"), N(4, "16"), N(4, "16"), N(4, "8"), N(4, "16"), N(4, "16"), N(3, "8"), N(3, "16"), N(3, "16"), N(3, "8"), N(3, "16"), N(3, "16")],
  [N(2, "8"), N(2, "16"), N(2, "16"), N(2, "8"), N(2, "16"), N(2, "16"), N(1, "8"), N(1, "16"), N(1, "16"), N(1, "8"), N(1, "16"), N(1, "16")],
  [N(0, "8"), N(0, "16"), N(0, "16"), N(0, "8"), N(0, "16"), N(0, "16"), N(4, "8"), N(4, "16"), N(4, "16"), N(4, "8"), N(4, "16"), N(4, "16")],
  [N(5, "8"), N(5, "16"), N(5, "16"), N(5, "8"), N(5, "16"), N(5, "16"), N(4, "8"), N(4, "16"), N(4, "16"), N(4, "8"), N(4, "16"), N(4, "16")],
...
for (const s of SONGS) {
  ...
  for (const r of s.repeats) {
    ...
    if (r.times !== undefined && r.times < 2) {
      throw new Error(`Song "${s.title}" has a repeat range {from: ${r.from}, to: ${r.to}} with times: ${r.times} — times must be at least 2 (omit the field for the default of 2)`);
    }
    prevTo = r.to;
  }
}
